  ...
  return (
    <div className={`relative w-[1024px] h-[35px] overflow-hidden ${className}`}>
      <p
        ...
        } font-avantgarde leading-[35px] whitespace-nowrap  ${direction === "up" ? "animate-scroll-left" : "animate-scroll-left"}`}
      >
    ...
    <div className="relative w-[1440px] h-[1024px]">
      <div className="absolute left-0 top-[-7px] w-[765px] h-[1031px]">
        <div className="relative h-[1031px] overflow-hidden">
          ...
          <ScrollingText className="absolute left-[179px] top-[494px] transform -rotate-90" property1="frame-2" no={true} direction="up"/>
          ...
          <ScrollingText className="absolute left-[230px] top-[468px] transform rotate-90" property1="frame-2" no={false} direction="down" />
        </div>
      </div>
      ...
      <div className="absolute left-[829px] top-[55px] w-[449px] h-[914px]">
        <div className="absolute left-[174px] top-[-38px] w-[142px] h-[207px]">
          <div className="absolute left-[23px] top-0 w-[111px] h-[148px]">
            ...
            <div className="absolute left-[59px] top-[33px] text-[80px] text-[#161616] font-extrabold font-['Helvetica_Compressed-Regular'] text-center">
              +
            </div>
          </div>
        ...
        <div className="absolute left-[142px] top-[210px] w-[198px] h-[207px]">
          <div className="absolute left-[29px] top-0 w-[163px] h-[148px]">
            ...
            <div className="absolute left-[111px] top-[33px] text-[80px] text-[#161616] font-extrabold font-['Helvetica_Compressed-Regular'] text-center">
              +
            </div>
          </div>
          <div className="absolute left-0 top-[116px] text-[76px] text-[#161616] font-vanguard font-medium  text-center whitespace-nowrap">
        ...
        <div className="absolute left-[81px] top-[458px] w-[346px] h-[207px]">
          <div className="absolute left-[70px] top-0 w-[202px] h-[148px]">
            ...
            <div className="absolute left-[150px] top-[32px] text-[80px] text-[#161616] font-extrabold font-['Helvetica_Compressed-Regular'] text-center">
              +
            </div>
          </div>
        ...
        <div className="absolute left-[29px] top-[706px] w-[449px] h-[207px]">
          <div className="absolute left-[141px] top-0 w-[164px] h-[148px]">
            ...
            <div className="absolute left-[112px] top-[33px] text-[80px] text-[#161616]  font-extrabold font-['Helvetica_Compressed-Regular'] text-center">
              +
            </div>
          </div>

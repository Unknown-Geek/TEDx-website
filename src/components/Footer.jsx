    ...
    <div id="contact" className=" w-screen h-full">
      ...
      <div className="gap-20 w-[330px] pt-20 flex flex-col space-y-4 lg:flex-row lg:justify-center lg:items-center lg:gap-20 lg:w-[1536px] lg:h-[433px] lg:left-[152px] lg:top-[91px] mx-auto ">
        ...
        <div className=" w-full h-[484px] rounded-[20px] overflow-hidden bg-[#161616] border-2 border-[#161616]">
          <div className=" h-[120px] text-center text-[#E31C25] text-[60px] md:text-[80px] font-semibold font-[Vanguard] pt-8 justify-center items-center">
            QUESTIONS?
          </div>
          <div className=" pt-1 text-center text-[#FAFAFA] text-[30px] md:text-[40px] font-semibold font-vanguard h-[100px]">
            WE<span className="font-bold font-avantgarde">'</span>RE HERE TO HELP<span className="font-bold font-avantgarde">!</span>
          </div>
          <div className=" pl-6 left-[46px] top-[229px] text-[#FAFAFA] text-[19px] md:text-[29px] font-bold font-[Microgramma]">
            AKHILJITH -
          </div>
          <div className=" left-[87px] top-[265px] text-right text-[#FAFAFA] text-[19px] md:text-[29px] font-bold font-[Microgramma] h-[80px]">
            <span className="pr-20 lg:pr-20 text-[#E31C25] ">7907982102</span>
          </div>
          <div className="pl-6 left-[46px] top-[309px] text-[#FAFAFA] text-[19px] md:text-[29px] font-bold font-[Microgramma]">
            EPHREM -
          </div>

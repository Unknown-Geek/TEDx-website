  ...
  return (
    <div className="w-full h-full bg-[#161616] overflow-hidden text-[#fafafa] font-vanguard">
      ...
      <div className="pt-10 flex flex-col gap-10 items-start px-6 md:px-28 max-w-[550px] ">
        ...
        {/* CTA Button */}
        <button className={`w-auto h-auto rounded-[15.26px] border-[2.3px] border-[#161616] shadow-[inset_0px_0px_10.84px_rgba(227,28,37,0.6)] overflow-hidden   
           ${isHovered
          ...
          <div className="flex flex-row flex-nowrap items-center justify-center w-[300px] h-full px-[25.2px] py-2 text-[24px] md:text-[35.86px] font-avantgarde font-bold">
            <span>BUY NOW</span>
            <ArrowRight className={`w-[32px] h-[32px] md:w-[52.8px] md:h-[52.8px] ml-2 -rotate-45 transition-all duration-300 ease-in-out ${isHovered ? "rotate-1" : "-rotate-45" }`}/>
          </div>
        </button>
      </div>
      <div className="flex flex-col justify-center items-center w-full h-full">
      <div className="md:pl-44 pt-8 flex items-center justify-center w-full h-full">
        <video src={ts} autoPlay loop muted playsInline className=" object-cover mix-blend-lighten w-[500px]"></video>
      </div>
      <div className="  overflow-hidden h-full  object-fill mix-blend-lighten md:pl-40 -mt-60 md:-mt-40 flex items-center justify-center">
